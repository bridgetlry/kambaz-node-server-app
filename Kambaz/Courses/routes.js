...
export default function CourseRoutes(app, db) {
    ...
    const createCourse = async (req, res) => {
        ...
        res.json({course : newCourse, enrollment: enrollment});
    };
    ...
    const enrollUserInCourse = async (req, res) => {
        ...
        const status = await enrollmentsDao
    ...
    const unenrollUserFromCourse = async (req, res) => {
        ...
        const status = await enrollmentsDao
            .unenrollUserFromCourse(uid, cid);
        res.send(status);
    };
    ...
    app.put("/api/courses/:courseId",
        updateCourse);
    app.post("/api/users/:uid/courses/:cid",
        enrollUserInCourse);
    app.delete("/api/users/:uid/courses/:cid",
